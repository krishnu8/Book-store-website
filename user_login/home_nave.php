        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="topNavBar">
                <form class="d-flex all">
                    <input class="form-control me-2" style="height:30px; text-align:center;" ; type="text" name="input" placeholder="Search">
                    
                    <button class="btn1 btn-primary btn" type="button" name="search"><a href="user_order_search.php" style=" color: #fff;">Search</button>
                    </a>
                </form>
