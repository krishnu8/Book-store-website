  ...
  <div class="main">
    ...
    <div class="container">
      <div class="row">
        ...
        <?php
        $selfe = "SELECT * FROM `review` WHERE  `product_id`='$product_id'";
        $oticount = mysqli_num_rows(mysqli_query($con, $selfe));
        $selavg="SELECT sum(`rating`) FROM `review` WHERE product_id='$product_id'";
        $avge=mysqli_fetch_array(mysqli_query($con,$selavg));
        if ($oticount != 0) {
        ?>
          <div class="container">
            <div class="row">
                ...
                <div class="well well-sm">
                  <div class="row">
                    <div class="col-xs-12 col-md-6 text-center">
                      ...
                      <div>
                        <span class="glyphicon glyphicon-user"></span><?php echo $oticount ?> total
                      </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
        ...
        $feedQu=mysqli_query($con,$selfe);
        while($feedback=mysqli_fetch_array($feedQu)){
        ?>
        
        <p style="background-color: #82cda8; font-size: 18px; margin-top: 2px;"><?php echo $feedback[2]; ?></p>
        <?php 
      }
      ?>
      </div>
