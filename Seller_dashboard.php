                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="box">
                            ...
                            <button class="btn-custom"  style="height:35px; width:50%">View Products</button>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="box">
                            ...
                            <button class="btn-custom" style="height:35px; width:50%">Orders</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="box">
                            ...
                            <button class="btn-custom"  style="height:35px; width:50%">View user</button>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="box">
