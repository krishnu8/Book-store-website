...
<tr>
    ...
    ?>
        ...
        <td><?php echo"$r[6]"?></td>
            ...
            <?php
                if($r['Status']=='Cancle'){
                    echo '<p><a href="order_active.php?Order_Id='.$r[1].'& Status=Active" style=" text-decoration: none; color: #fff; margin-top: 5px;">
                    <button class="btn btn-success" style="width:100px">Activate</button></a></p>';
                }else{
                    echo '<p><a href="order_cancel.php?Order_Id='.$r[1].'& Status=Cancle" style=" text-decoration: none; color: #fff; margin-top: 5px;">
                    <button class="btn btn-warning" style="width:100px">Deactive</button></a></p>';
                }
    ...
    <div class="row"> -->
        <div class="col-sm-4 pagination" style="text-align:center">
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                if ($i == $page) {
                    $pagLink .= "<a class = 'active' href='Orders.php?page="
                        . $i . "'>" . $i . " </a>";
                } else {
                    $pagLink .= "<a href='Orders.php?page=" . $i . "'>   
                                                " . $i . " </a>";
                }
            };
            echo $pagLink;
