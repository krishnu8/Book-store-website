...
<table >
    ...
    <tr class="a0">
        <td colspan="2" style="font-size: 20px;">Return Back To Privious Page?<a href="../User.php" style="text-decoration: none; color: green;">Return</a></td>
    </tr>
</table>
</form>
<?php
        if (isset($_POST['btn'])) {
            ...
            `State`='$st',`City`='$ct',`About`='$ab',`User_id`='$u_id'WHERE role='User'";
