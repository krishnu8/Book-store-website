...
?>
    ...
    <div class="row">
        ...
        <div class=" offset-sm-6 col-sm-2">
            <div class="row">
                <div class="col">
                    <a href="../register.php" style="margin-left: 50px;"><button class="btn btn-danger">Add New User</button></a>
                </div>
            </div>
...
<table class="table table-striped" border="1" id="myTable">
    ...
    ?>
        <tr>
            ...
            <td> 
                <a href="Sellers/Seller_Edit.php?User-id=<?php echo $r[0]; ?>"><button class="btn btn-info" style="width:70px">Edit</button></a>
            </td>
            <td> 
                <a href="Sellers/Seller_Delete.php?User-id=<?php echo $r[0]; ?>"><button class="btn btn-danger" style="width:100px">Delete</button></a>
            </td>
            
            <td>
            <?php
                if($r['Status']=='Inactive'){
                    echo '<p><a href="Sellers/Seller_active.php?User_id='.$r[10].'& Status=Active" style=" text-decoration: none; color: #fff; margin-top: 5px;">
                    <button class="btn btn-success" style="width:100px">Activate</button></a></p>';
                }else{
                    echo '<p><a href="Sellers/Seller_inactive.php?User_id='.$r[10].'& Status=Inactive" style=" text-decoration: none; color: #fff; margin-top: 5px;">
...
<div class="container">
    <div class="row"> -->
        <div class="col-sm-4 pagination" style="text-align:center">
            <?php
            $q1 = "SELECT * FROM Registration WHERE role='Seller'";
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                if ($i == $page) {
                    $pagLink .= "<a class = 'active' href='Seller.php?page="
                        . $i . "'>" . $i . " </a>";
                } else {
                    $pagLink .= "<a href='Seller.php?page=" . $i . "'>   
                                                " . $i . " </a>";
                }
            };
            echo $pagLink;
